...
// void pushFront(struct s_deque *deque, int value, int *arr);
// void pushBack(struct s_deque *deque, int value, int *arr);
// int popFront(struct s_deque *deque, int *arr);
// int popBack(struct s_deque *deque, int *arr);
